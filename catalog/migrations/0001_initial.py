# Generated by Django 4.1.6 on 2023-02-12 18:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(max_length=29, null=True, on_delete=models.SET('ratatatatata'), to='catalog.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(max_length=250, null=True, verbose_name='Номер версии')),
                ('name_of_version', models.CharField(max_length=250, null=True, verbose_name='Название версии')),
