    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', tinymce.models.HTMLField(blank=True, default='', verbose_name='Описание')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'permissions': (('change_status', 'can change status'), ('change_info', 'can change info'), ('change_category', 'can change category')),
            },
        ),
        migrations.CreateModel(
            name='Version',
